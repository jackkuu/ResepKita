...
function call_ollama_api($prompt, $url, $model)
{
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['generate_nutrition']) && $recipe) {
        // Only allow AI nutrition generation for premium users
        if (empty($is_premium)) {
            $ai_error = 'Fitur estimasi nutrisi hanya tersedia untuk pengguna Premium. Silakan login dan upgrade.';
        } else {
            ...
            <div class="recipe-detail-header">
                ...
                <div class="recipe-detail-info">
                    ...
                    <div style="margin-top:18px;">
                        ...
                        <?php else: ?>
                            <button type="button" disabled style="opacity:0.7;cursor:not-allowed;">Estimasi Nutrisi (AI)</button>
                            <div style="display:inline-block;margin-left:12px;font-size:14px;color:#666;">Hanya untuk pengguna <strong>Premium</strong>. <a href="login.php">Login / Upgrade</a></div>
                        <?php endif; ?>

                        <?php if ($ai_error): ?>
                            <div style="margin-top:12px;color:#b00;font-size:14px;"><?php echo htmlspecialchars($ai_error); ?></div>
                        <?php endif; ?>
