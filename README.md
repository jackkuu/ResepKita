...
4. **Setup AI**: Setup ollama mistral on your local.
5. **Run the Application**: Start your local server (e.g., XAMPP) and navigate to `http://localhost/project/tugas entre/public/index.php` to access the application.
...
- This website also using ollama mistral as its AI helper.
